...
plot(ans$Date,as.numeric(ans$Voltage), type="l", ylab = "Voltage",xlab="datetime")
...
plot(ans$Date,as.numeric(ans$Global_reactive_power), type="l", ylab = "Global reactive power",xlab="datetime")
